    ...
    <section className="text-gray-600 body-font">
      <div className="container px-5 md:py-24 sm:py-15 mx-auto flex flex-wrap items-center">
        ...
        <div className="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:mx-auto w-full mt-10 md:mt-0">
          <h2 className="text-gray-900 text-lg font-medium title-font text-2xl mb-5 text-center">Sign Up</h2>
          ...
          <p className="mt-5 inline-flex  justify-center">Already register ? <Link className="text-indigo-500  px-3" to={"/login"} >Login here</Link></p>
