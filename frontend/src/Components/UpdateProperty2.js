    ...
    return new Promise((resolve, reject) => {
      setTimeout(() => {
        ...
        imgs.forEach(async (image) => {
          const img = new Image();
          img.src = require(`C:/Users/ruchi/Desktop/Project-RealEstate/RealEstate/frontend/src/Images/${image}`);
  ...
  useEffect(() => {
    ...
    images.forEach((image) => {
      ...
      if (blob.size < 100) {
        ...
        newImageUrls.push(
          require(`C:/Users/ruchi/Desktop/Project-RealEstate/RealEstate/frontend/src/Images/${image.name}`)
        );
      }
      else {
