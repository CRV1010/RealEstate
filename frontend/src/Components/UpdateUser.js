...
const UpdateUser = () => {
  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 md:py-20 sm:py-15 mx-auto flex flex-wrap items-center">
        <div className="lg:w-2/6 md:w-1/2 bg-gray-200 rounded-lg p-8 flex flex-col md:mx-auto w-full mt-5 md:mt-0">
