...
function About() {
  return (
    <div className="bg-slate-100">
      ...
      <div>
        <h1 id="focus">
          <strong style={{ "margin-left": "500px" }}> Our Focus On... </strong>
        </h1>
        <div id="focusContainer">
          <p id="focusText">
            ...
            buying, selling, or renting properties. Whether you're a homeowner,
            a buyer or a tenant our platform offers you a seamless and
            user-friendly experience to meet your real estate needs.
          </p>
